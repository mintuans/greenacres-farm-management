...
import { updateBlogPost, getBlogCategoriesForManagement, BlogCategory, getAllBlogPostsForManagement } from '../../services/blog.service';
...
const EditBlog: React.FC = () => {
    ...
    const loadPost = async () => {
        try {
            setLoadingPost(true);
            const response = await getAllBlogPostsForManagement({ limit: 1000 });
            ...
            if (post) {
                setFormData({
                    ...
                    thumbnail_id: post.featured_image_id || '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert(error.response?.data?.message || 'Có lỗi khi cập nhật bài viết!');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="mb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-[#111813]">Chỉnh sửa bài viết</h1>
                </div>
                <p className="text-sm text-gray-500 ml-14">Cập nhật thông tin bài viết</p>
            </div>
