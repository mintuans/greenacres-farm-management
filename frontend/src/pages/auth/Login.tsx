    ...
    return (
        <div className="bg-[#f6f8f6] min-h-screen flex flex-col font-['Plus_Jakarta_Sans',_sans-serif]">
            ...
            <header className="flex items-center justify-between px-6 md:px-10 py-6">
                ...
                <Link to="/showcase" className="text-sm font-bold text-[#61896b] hover:text-[#13ec49] transition-colors flex items-center gap-1 group">
            ...
            <main className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="w-full max-w-[480px] bg-white rounded-[40px] shadow-2xl shadow-slate-200/50 border border-white p-8 md:p-12 z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="flex flex-col items-center mb-10">
                        <h1 className="text-[#111813] text-4xl font-black leading-tight tracking-tight mb-3">Chào mừng bạn!</h1>
                        <p className="text-[#61896b] text-base font-bold text-center leading-relaxed italic opacity-80">Đăng nhập để quản lý nông trại của bạn</p>
                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        ...
                        <div className="space-y-2 group">
                            <div className="flex justify-between items-center ml-2">
                                ...
                                <a className="text-[#13ec49] text-[10px] font-black uppercase tracking-widest hover:underline" href="#">Quên mật khẩu?</a>
                            </div>
                            <div className="relative">
                                <input
                    ...
                    <div className="flex items-center my-10">
                        ...
                        <span className="px-4 text-[10px] font-black text-[#61896b] uppercase tracking-[0.3em]">Hoặc</span>
                        <div className="flex-1 h-[2px] bg-[#f0f4f1]"></div>
                    </div>
