                ...
                <div className="w-full max-w-[540px] bg-white rounded-[40px] shadow-2xl shadow-slate-200/50 border border-white p-8 md:p-12 z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <span className="ml-3 text-sm font-black text-[#111813] uppercase tracking-widest">Gmail</span>
                        </button>
                        <button
                            onClick={() => {
                                const backendUrl = import.meta.env.VITE_API_URL || '';
                        ...
                        >
                            ...
                            <span className="ml-3 text-sm font-black text-[#111813] uppercase tracking-widest">Facebook</span>
                        </button>
                    </div>
                </div>
            </main>
