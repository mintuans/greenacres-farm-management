                        ...
                        <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Hệ thống quản trị GreenAcres</p>
                                </div>
                            </div>
                            ...
                            <div id="payroll-slip-print" className="bg-white shadow-sm border border-slate-200 mx-auto w-full p-10 flex flex-col font-serif min-h-[600px]">
                                <div className="flex justify-between items-start border-b-2 border-slate-900 pb-8 mb-8">
                                    <div>
                                        ...
                                        <p className="text-xs font-bold text-slate-500 font-sans mt-1 uppercase tracking-widest text-[8px]">Green Acres Smart Farm Management</p>
                                    </div>
                                ...
                                <div className="mt-auto grid grid-cols-2 gap-20 text-center font-sans">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-slate-900 uppercase">GreenAcres Management</p>
                                    </div>
                                </div>
