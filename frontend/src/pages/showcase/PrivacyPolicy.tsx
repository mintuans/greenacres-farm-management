                    ...
                    <div className="layout-content-container flex flex-col max-w-[950px] flex-1 gap-12">
                        ...
                        <div className="bg-white rounded-[2.5rem] border border-[#dbe6de] shadow-sm p-8 md:p-12">
                            <p className="text-[#3c4740] text-lg leading-relaxed mb-6 italic">
                                GreenAcres luôn tôn trọng sự riêng tư của khách hàng, và đó là lý do chúng tôi luôn cam kết bảo vệ những thông tin cá nhân của khách hàng.
                            </p>
                            <p className="text-[#3c4740] leading-relaxed">
                                Trong tài liệu này, khái niệm "thông tin cá nhân" được hiểu bao gồm tên, địa chỉ, địa chỉ email, số điện thoại hay bất kỳ thông tin cá nhân nào khác mà khách hàng cung cấp, hoặc bất kỳ thông tin nào về khách hàng được thu thập theo luật định hiện hành. Mong rằng tài liệu sẽ giúp bạn hiểu rõ những thông tin cá nhân nào mà GreenAcres sẽ thu thập, cũng như cách chúng tôi sử dụng những thông tin này sau đó.
                            </p>
                        ...
                        <div className="grid grid-cols-1 gap-10">
                            ...
                            <section className="bg-white rounded-3xl border border-[#dbe6de] p-8 shadow-sm">
                                ...
                                <div className="space-y-4 text-[#3c4740] leading-relaxed">
                                    <p>Khi lập trình trang web, chúng tôi có thể đặt những luật định hợp lý mang tính thương mại để ngăn chặn hành vi truy cập bất hợp pháp và việc sử dụng không thích đáng các thông tin cá nhân của bạn đã gửi cho GreenAcres thông qua việc sử dụng trang web này. Nếu trang web này hỗ trợ việc giao dịch trực tuyến, nó sẽ được áp dụng một tiêu chuẩn công nghệ được gọi là SSL (Secure Sockets Layer), để bảo vệ tính bảo mật và an toàn trên đường truyền dữ liệu.</p>
                                    <p>Vì luôn có những rủi ro liên quan đến vấn đề cung cấp dữ liệu cá nhân, cho dù là cung cấp trực tiếp, qua điện thoại hay qua mạng internet, hay qua các phương tiện kỹ thuật khác; và không có hệ thống kỹ thuật nào an toàn tuyệt đối hay chống được tất cả các "hacker" và "tamper", GreenAcres luôn nỗ lực tiến hành những biện pháp đề phòng thích hợp đối với từng đặc tính của thông tin để ngăn chặn và giảm thiểu tối đa các rủi ro có thể khi bạn sử dụng trang web này.</p>
                                </div>
                            </section>
                            ...
                            <section className="bg-white rounded-3xl border border-[#dbe6de] p-8 shadow-sm">
                                ...
                                <p className="text-[#3c4740] leading-relaxed">
                                    GreenAcres sẽ chủ động hoặc theo yêu cầu của bạn bổ sung, hiệu chỉnh hay tẩy xóa các dữ liệu thông tin cá nhân không chính xác, không đầy đủ hoặc không cập nhật khi bạn còn liên kết với hoạt động của chúng tôi.
                                </p>
                            </section>
                            ...
                            <section className="bg-white rounded-3xl border border-[#dbe6de] p-8 shadow-sm">
                                ...
                                <p className="text-[#3c4740] leading-relaxed">
                                    GreenAcres từ chối phục vụ cá nhân còn ở độ tuổi Trẻ vị thành niên (do luật pháp địa phương mà bạn cư ngụ quy định) không được quyền mua hay tìm cách sử dụng dựa trên điều lệ hợp pháp khác trên trang web này nếu không có sự chấp thuận của ba/mẹ hay người giám hộ hợp pháp, trừ khi luật pháp địa phương có áp dụng hay cho phép.
                                </p>
                            </section>
                            ...
                            <section className="bg-white rounded-3xl border border-[#dbe6de] p-8 shadow-sm">
                                ...
                                <p className="text-[#3c4740] leading-relaxed">
                                    Trang web này có thể chứa các đường liên kết đến các trang web khác được đặt vào nhằm mục đích giới thiệu hoặc bổ sung thông tin liên quan để bạn tham khảo. GreenAcres không chịu trách nhiệm về nội dung hay các hành vi của bất kỳ trang web nào khác.
                                </p>
                            </section>
                            ...
                            <section className="bg-white rounded-3xl border border-[#dbe6de] p-8 shadow-sm">
                                ...
                                <p className="text-[#3c4740] leading-relaxed">
                                    GreenAcres có thể thay đổi quy định này một cách không thường xuyên, bao gồm việc bổ sung, loại bỏ một phần nội dung hoặc tạm ngưng trang web mà không cần báo trước. Tuy nhiên, nếu quy định này được thay đổi theo hướng có thể gây bất lợi cho bạn, GreenAcres sẽ cố gắng thông báo về sự thay đổi qua e-mail bạn đã cung cấp hoặc ngay trên trang chủ.
                                </p>
                            </section>
