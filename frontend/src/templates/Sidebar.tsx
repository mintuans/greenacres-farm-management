            ...
            `}>
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className={`text-[13px] font-medium transition-all duration-300 origin-left ${isCollapsed ? 'md:opacity-0 md:scale-0 md:absolute' : 'opacity-100 scale-100'}`}>Chấm công</span>
                            </div>
                            {!isCollapsed && (
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className={`text-[13px] font-medium transition-all duration-300 origin-left ${isCollapsed ? 'md:opacity-0 md:scale-0 md:absolute' : 'opacity-100 scale-100'}`}>Danh mục</span>
                            </div>
                            {!isCollapsed && (
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className={`text-[13px] font-medium transition-all duration-300 origin-left ${isCollapsed ? 'md:opacity-0 md:scale-0 md:absolute' : 'opacity-100 scale-100'}`}>Nhà kho</span>
                            </div>
                            {!isCollapsed && (
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className={`text-[13px] font-medium transition-all duration-300 origin-left ${isCollapsed ? 'md:opacity-0 md:scale-0 md:absolute' : 'opacity-100 scale-100'}`}>Cài đặt</span>
                            </div>
                            {!isCollapsed && (
                ...
                <div className="p-2 border-t border-slate-100 flex flex-col gap-1 mt-auto">
                    ...
                    >
                        ...
                        <span className={`text-[13px] font-medium transition-all duration-300 origin-left ${isCollapsed ? 'md:opacity-0 md:scale-0 md:absolute' : 'opacity-100 scale-100'}`}>Đăng xuất</span>
                        {isCollapsed && (
